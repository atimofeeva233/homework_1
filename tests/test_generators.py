...
def test_filter_by_rub(filter_by_rub):
    ...
    ], currency='RUB')) == filter_by_rub


def test_filter_by_usd(filter_by_usd):
    assert list(filter_by_currency([
        {
            "id": 939719570,
            "state": "EXECUTED",
    ...
    ], currency='USD')) == filter_by_usd


def test_filter_by_not_usd():
    with pytest.raises(TypeError):
        assert list(filter_by_currency({
            ...
            "to": "Счет 74489636417521191160"},
            {
                ...
                "description": "Перевод организации",
                "from": "Visa Platinum 1246377376343588",
                "to": "Счет 14211924144426031657"}, currency='USD'))


def test_filter_by_not():
...
@pytest.mark.parametrize("start,end,expected_first,expected_last,expected_count", [
    ...
    (1234567890123456, 1234567890123458,
     "1234 5678 9012 3456", "1234 5678 9012 3458", 3),
    (9999999999999997, 9999999999999999,
     "9999 9999 9999 9997", "9999 9999 9999 9999", 3),
])
